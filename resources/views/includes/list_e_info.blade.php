        ...
        <form class="frm-search" action="{{route('emp_rent.index')}}" id="formSearch">
            @if(isset($filter) && $filter)
                @foreach($filter as $f)
                    ...
                    @endif
                @endforeach
                @if(isset($not_btn_search)&&$not_btn_search==true)
        ...
        var listTable = {
            ...
            getAjaxModal: function () {
                $(document).find('a[data-view=ajax]').click(function (e) {
                    ...
                    is_additional_order = $(this).data('is_additional_order');
                    params = {
                        phap_nhan: phap_nhan,
