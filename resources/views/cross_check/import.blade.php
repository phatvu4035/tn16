...
@section('content')
    ...
    <div class="row gap-20 masonry pos-r">
        ...
        <div class="masonry-item col-md-12">
            ...
            {{Form::openForm('Import dữ liệu đối soát '.$type ,['method'=>'POST', 'id'=>'form-import','files' => true])}}
            <div class="form-row">
                <div class="form-group">
                    ...
                    <button type="button" class="btn btn-primary" id="btnUpload" disabled><i class="fa fa-upload"></i> Import</button>
